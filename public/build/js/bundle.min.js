function eventListeners(){document.querySelector(".mobile-menu").addEventListener("click",navegacionTab)}function navegacionTab(){document.querySelector(".n1").classList.toggle("mostrar")}
